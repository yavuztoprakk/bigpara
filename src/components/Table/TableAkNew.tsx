...
import HeaderColumnAkNew from "./HeaderColumnAkNew";
import ColumnAkNew from "./ColumnAkNew";
import Animated, {
    useSharedValue,
            ...
            >
                ...
                >
                    {scrollColumns.map((column, i) => (
                        <HeaderColumnAkNew key={i} {...column} />
                    ))}
                </Animated.View>
            </View>
        </View>
